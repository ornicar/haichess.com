...
object Dependencies {
  ...
  object Resolvers {
    ...
    val aliyun = "aliyun" at "https://maven.aliyun.com/repository/central"
    ...
    val maven = "Local Maven" at "file://" + Path.userHome.absolutePath + "/.m2/repository"
  ...
  val aliyun = "com.aliyun" % "aliyun-java-sdk-core" % "4.0.3"
  val alipay = "com.alipay.sdk" % "alipay-easysdk" % "2.1.0"
