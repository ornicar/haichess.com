...
function whatNext(ctrl) {
  ...
  return m('div.categ.what_next', [
    ...
    m('div.categ_stages', [
      ...
      makeStage('/training/coordinate', 'tied-scroll', 'videos', 'watchInstructiveChessVideos'),
      makeStage('/lobby#hook', 'sword-clash', 'playPeople', 'opponentsFromAroundTheWorld'),
      makeStage('/lobby#ai', 'vintage-robot', 'playMachine', 'testYourSkillsWithTheComputer'),
    ])
  ]);
}
