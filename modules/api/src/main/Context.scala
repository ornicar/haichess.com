...
import lila.common.{ HTTPRequest, Lang, Nonce }
import lila.pref.Pref
import lila.clazz.ClazzUser
import lila.relation.actorApi.OnlineFriends
import lila.user.{ BodyUserContext, HeaderUserContext, User, UserContext }
...
sealed trait Context extends lila.user.UserContextWrapper {
  ...
  def isMyClassmateOrCoach(user: User) = pageData.clazzUser.isMyClassmateOrCoach(user.id)
