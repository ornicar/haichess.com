...
final class Env(
    ...
    getContestBoard: lila.game.Game => Fu[Option[lila.contest.Board]],
...
object Env {
  ...
  lazy val current = "api" boot new Env(
    ...
    getContestName = lila.contest.Env.current.cached.name,
    getContestBoard = lila.contest.Env.current.contestApi.contestBoard,
