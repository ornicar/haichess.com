...
package team {
  ...
  case class SetOwner(id: String, name: String, userId: String)
  case class UnsetOwner(id: String, name: String, userId: String)
...
case class Recall(id: Option[String], homeworkId: Option[String], win: Boolean, turns: Int, userId: String)
...
package member {
  ...
  case class MemberPointsChange(userId: String, typ: String, diff: Int, orderId: Option[String])

  case class MemberCoinChange(userId: String, typ: String, diff: Int, orderId: Option[String])

  case class MemberCardUse(userId: String, level: String, days: Int, desc: String)
}
