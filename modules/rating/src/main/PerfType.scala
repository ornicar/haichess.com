...
object PerfType {
  ...
  val nonPuzzleShort: List[PerfType] = List( /*UltraBullet, */ Bullet, Blitz, Rapid, Classical, Correspondence)
  val nonPuzzleShort2: List[PerfType] = List(UltraBullet, Bullet, Blitz, Rapid, Classical, Correspondence)
  val nonGame: List[PerfType] = List(Puzzle)
  val leaderboardable: List[PerfType] = List(Bullet, Blitz, Rapid, Classical, UltraBullet, Crazyhouse, Chess960, KingOfTheHill, ThreeCheck, Antichess, Atomic, Horde, RacingKings, Puzzle)
  val leaderboardableShort: List[PerfType] = List(UltraBullet, Bullet, Blitz, Rapid, Classical, Correspondence, Puzzle)
  val stat: List[PerfType] = List(UltraBullet, Bullet, Blitz, Rapid, Classical, Correspondence, Puzzle)
