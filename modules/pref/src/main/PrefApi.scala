...
final class PrefApi(
  ...
  private implicit val prefBSONHandler = new BSON[Pref] {
    ...
    def reads(r: BSON.Reader): Pref = Pref(
      ...
      homeShare = r.getD("homeShare", Pref.default.homeShare),
      followShare = r.getD("followShare", Pref.default.followShare),
    ...
    def writes(w: BSON.Writer, o: Pref) = $doc(
      ...
      "homeShare" -> o.homeShare,
      "followShare" -> o.followShare,
