...
object Pref {
  ...
  val defaultBgImg = "//haichess.com/assets/images/background/landscape.jpg"
  ...
  lazy val default = Pref(
    ...
    homeShare = HomeShare.FRIENDS,
    followShare = FollowShare.FRIENDS,
    keyboardMove = KeyboardMove.NO,
    zen = Zen.NO,
    rookCastle = RookCastle.NO,
