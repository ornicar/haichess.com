...
final class Env(
  ...
  object file {
    private lazy val fileColl = apply(config getString "file.collection")
    import dsl._
    import DbFile.DbFileBSONHandler
    def fetch(id: String): Fu[Option[DbFile]] = fileColl.byId[DbFile](id)
  }
