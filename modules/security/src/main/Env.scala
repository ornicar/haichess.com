...
final class Env(
    config: Config,
    captcherActor: ActorSelection,
    smsCaptcherActor: ActorSelection,
  ...
  private val AliYunApiUrl = config getString "aliyun.api.url"
  private val AliYunApiKey = config getString "aliyun.api.key"
  private val AliYunApiSecret = config getString "aliyun.api.secret"
  ...
  private val CaptcherAcotorName = config getString "smsCaptcher.name"
  ...
  lazy val forms = new DataForm(
    captcherActor = captcherActor,
    smsCaptcherActor = smsCaptcherActor,
  ...
  private lazy val mailgun = new Mailgun(
    apiUrl = AliYunApiUrl,
    apiKey = AliYunApiKey,
    apiSecret = AliYunApiSecret,
    from = MailgunSender,
    replyTo = MailgunReplyTo,
    system = system
  )

  private lazy val smsgun = new Smsgun(
    apiUrl = AliYunApiUrl,
    apiKey = AliYunApiKey,
    apiSecret = AliYunApiSecret,
    system = system
  ...
  system.actorOf(
    Props(new SmsCaptcher(smsgun)),
    name = CaptcherAcotorName
  )
...
object Env {
  ...
  lazy val current = "security" boot new Env(
    ...
    captcherActor = lila.hub.Env.current.captcher,
    smsCaptcherActor = lila.hub.Env.current.smsCaptcher,
