...
object Permission {
  ...
  case object ManageContest extends Permission("ROLE_MANAGE_CONTEST")
  ...
  case object TeamOrCoach extends Permission("ROLE_TEAM_OR_COACH")
  case object Team extends Permission("ROLE_TEAM", List(
    Prismic
  ))
  ...
  case object Admin extends Permission("ROLE_ADMIN", List(
    ...
    MessageAnyone, ManageTeam, TerminateTournament, ManageTournament, ManageContest, ManageEvent,
  ...
  lazy val allButSuperAdmin: List[Permission] = List(
    ...
    Beta, MessageAnyone, UserSearch, ManageTeam, TerminateTournament, ManageTournament, ManageContest, ManageEvent,
    PublicMod, Developer, Coach, Team, ModNote, RemoveRanking, ReportBan, Impersonate,
