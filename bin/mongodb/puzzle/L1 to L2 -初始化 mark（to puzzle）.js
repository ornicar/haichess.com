db.L1_puzzle_mark.find().forEach(function(obj) {
    var game_ = obj.game;
    ...
    data.idHistory.source = "lichess-mark";
    ...
    data.perf = {};
    data.perf.gl = {};
    data.perf.gl.r = parseFloat(puzzle_.rating) - 100;
    data.perf.gl.d = 150.0;
    data.perf.gl.v = 0.06;
