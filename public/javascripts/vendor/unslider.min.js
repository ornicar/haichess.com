(function (e, t) {
    ...
    var n = function () {
        ...
        this.setup = function () {
            ...
            if (this.opts.arrows) {
                this.el.append('<span class="arrow prev"><i></i></span>')
                    .append('<span class="arrow next"><i></i></span>');
...
/*                this.el.css(s, o) && this.ul.animate(e.extend({left: "-" + t + "00%"}, s), o, function (i) {
                    n.current = t;
                    e.isFunction(n.opts.complete) && !r && n.opts.complete(n.el)
                })*/

                this.el.css(s) && this.ul.css(e.extend({left: "-" + t + "00%"}, s)).fadeIn()
                n.current = t;
            //}
        };
        this.start = function () {
        ...
        this.dots = function () {
            ...
            e.each(this.items, function (e) {
                t += '<li class="dot' + (e < 1 ? " active" : "") + '"><span class="btn"></span></li>'
            });
            t += "</ol>";
