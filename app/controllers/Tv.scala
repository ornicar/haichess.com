...
object Tv extends LilaController {
  ...
  def embed = Action { req =>
    Ok {
      ...
      s"""document.write("<iframe src='https://$url&embed=" + document.domain + "' class='lichess-tv-iframe' allowtransparency='true' frameborder='0' style='width: 224px; height: 264px;' title='Haichess free online chess'></iframe>");"""
