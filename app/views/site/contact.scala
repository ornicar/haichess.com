...
object contact {
  ...
  private def howToReportBugs: Frag = frag(
    ul(
      li(
        "In the ",
        a(href := routes.ForumCateg.show("lichess-feedback"))("Haichess Feedback Forum")
      ),
      li(
        "As a ",
        a(href := "https://github.com/ornicar/lila/issues")("Haichess website issue"),
        " on GitHub"
      ),
      li(
        "As a ",
        a(href := "https://github.com/veloce/lichobile/issues")("Haichess mobile app issue"),
        " on GitHub"
      ),
      li(
        "In the ",
        a(href := "https://discord.gg/hy5jqSs")("Haichess discord server")
      )
    ),
    ...
    Branch("root", "What can we help you with?", List(
      Branch("login", "I can't log in", List(
        ...
        Leaf("dns", "\"This site can’t be reached\"", frag(
          p("If you can't reach Haichess, and your browser says something like:"),
          ul(
            li("This site can't be reached."),
            li(strong("haichess.com"), "’s server IP address could not be found."),
            li("We can’t connect to the server at haichess.com.")
          ),
      ...
      Branch("account", "I need account support", List(
        Leaf("title", "I want my title displayed on Haichess", frag(
          p(
            "To show your title on your Haichess profile, and participate to Titled Arenas, ",
      ...
      Branch("collab", "Collaboration, legal, commercial", List(
        Leaf("monetize", "Monetizing Haichess", frag(
          p("We are not interested in any way of monetizing Haichess."),
        ...
        Leaf("buy", "Buying Haichess", frag(
          p("We are not selling, to anyone, for any price. Ever.")
        )),
        Leaf("authorize", "Authorization to use Haichess", frag(
          p("You are welcome to use Haichess for your activity, even commercial."),
          p("You can show it in your videos, and you can print screenshots of Haichess in your books."),
          p("Credit is appreciated but not required.")
        )),
        Leaf("gdpr", "GDPR", frag(
          p("If you are a European citizen, you may request the deletion of your Haichess account."),
          p(
            "First, ",
        ...
        Leaf("contact-other", "None of the above", frag(
          ...
          p(
            ...
            "State your Haichess username, and any information that could help us help you."
          )
        ))
      ))
    ))
  ...
  private def goBack(parent: Node): Frag =
    a(makeLink(parent.id), cls := "back", dataIcon := "I", title := "返回")
