  ...
  def apply()(implicit ctx: Context) = help.layout(
    ...
    moreCss = cssTag("faq")
      ...
      main(cls := "faq small-page box box-pad")(
        h1(cls := "lichess_title")("常见问题") /*,
        h2("Haichess"),
        question(
          "name",
          "Why is Haichess called Haichess?",
          p("Haichess is a combination of live/light/libre and chess. It is pronounced ", em("lee-chess"), "."),
          p("Live, because games are played and watched in real-time 24/7; light and libre for the fact that Haichess is open-source and unencumbered by proprietary junk that plagues other websites."),
          p("Similarly, the source code for Haichess, ", a(href := "https://github.com/ornicar/lila")("lila"), ", stands for li[chess in sca]la, seeing as the bulk of Haichess is written in ", a(href := "https://www.scala-lang.org/")("Scala"), ", an intuitive programming language.")
        ),
        question(
          "contributing",
          "How can I contribute to Haichess?",
          p("Haichess is powered by donations from patrons and the efforts of a team of volunteers."),
          p("You can find out more about ", a(href := routes.Plan.index())("being a patron"), " (including a ", a(href := routes.Main.costs())("breakdown of our costs"), "). If you want to help Haichess by volunteering your time and skills, there are many ", a(href := routes.Page.help())("other ways to help"), ".")
        ),
        question(
          "sites_based_on_Lichess",
          "Are there websites based on Haichess?",
          p(
            "Yes. Haichess has indeed inspired other open-source sites that use our ",
        ...
        question(
          ...
          p("Haichess has strong detection methods and a very thorough process for reviewing all the evidence and making a decision. The process often involves many moderators and can take a long time. Other than the mark itself, we will not go into details about evidence or the decision making process for individual cases. Doing so would make it easier to avoid detection in the future, and be an invitation to unproductive debates. That time and effort is better spent on other important cases. Users can appeal by emailing contact@haichess.com, but decisions are rarely overturned.")
        ),
        question(
          "rating-refund",
        ...
        question(
          ...
          p("On Haichess, the main difference in rules for correspondence chess is that an opening book is allowed. The use of engines is still prohibited and will result in being flagged for engine assistance. Although ICCF allows engine use in correspondence, Haichess does not.")
        ),
        h2("Gameplay"),
        question(
          "variants",
          "What variants can I play on Haichess?",
          p("Haichess supports standard chess and ", a(href := routes.Page.variantHome())("8 chess variants"), ".")
        ),
        question(
          "acpl",
          ...
          p("The computer analysis on Haichess is powered by Stockfish.")
        ),
        question(
          "timeout",
        ...
        question(
          ...
          p("See the ", a(href := s"${routes.Learn.index()}#/15")("Haichess training"), " on this move for some practice with it.")
        ),
        h2("Accounts"),
        question(
          "titles",
          "What titles are there on Haichess?",
          p(
            "Haichess recognises all FIDE titles gained from OTB (over the board) play, as well as ",
          ...
          p("Verifying as a titled player on Haichess gives access to play in the Titled Arena events."),
          p("Finally there is an honorary ", a(href := "#lm")("Haichess Master (LM)"), " title.")
        ),
        question(
          "lm",
          "How do I get the Haichess Master (LM) title?",
          p("This honorific title is unofficial and only exists on Haichess."),
          p("We award it to highly notable players who are good citizens of Haichess, at our discretion. You don't get the LM title, the LM title gets to you. If you qualify, you will get a message from us regarding it and the choice to accept or decline.")
        ),
        question(
          "usernames",
        ...
        question(
          ...
          p("That trophy is unique in the history of Haichess, nobody other than ", a(href := "https://haichess.com/@/hiimgosu")("hiimgosu"), " will ever have it."),
          p("To get it, hiimgosu challenged himself to berserk and win 100% games of ", a(href := "https://haichess.com/tournament/cDyjj1nL")("a hourly bullet tournament"), "."),
          h4("The Golden Zee"),
          p("That trophy is unique in the history of Haichess, nobody other than ", a(href := "https://haichess.com/@/ZugAddict")("ZugAddict"), " will ever have it."),
        ...
        question(
          "ratings",
          "What rating system does Haichess use?",
