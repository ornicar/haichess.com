...
<html>
  <head>
    <meta charset="utf-8"/>
    <meta http-equiv="Content-Security-Policy" content="default-src 'self'; style-src https://fonts.googleapis.com 'unsafe-inline'; font-src https://fonts.gstatic.com; script-src 'unsafe-eval' https://cdn.jsdelivr.net blob:; connect-src https://raw.githubusercontent.com; img-src data: https://haichess.com;">
    <title>Haichess HTTP API documentation</title>
