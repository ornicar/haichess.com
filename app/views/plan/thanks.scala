    ...
    views.html.base.layout(
      ...
      title = "Thank you for your support!"
        ...
        main(cls := "page-small page box box-pad")(
          ...
          div(cls := "body")(
            p("Thank you for helping us build Haichess. ", strong("You rock!")),
            p(
            ...
            patron.map { pat =>
              if (pat.payPal.??(_.renew)) p(
                ...
                if (customer.??(_.renew)) frag(
                  ...
                  if (pat.isLifetime) p(
                    "You are now a lifetime Haichess Patron!", br,
                    ctx.me.map { me =>
                      frag("Check out your ", a(href := routes.User.show(me.username))("profile page"), ".")
                    }
                  )
                    ...
                    p(
                      "You are now a Haichess Patron for one month!", br,
                      ctx.me.map { me =>
                        frag("Check out your ", a(href := routes.User.show(me.username))("profile page"), ".")
                      }
                    ),
                    p(
                      ...
                      "and your Haichess account will be downgraded to free."
                    ),
                    p(
            ...
            p("Success! ", a(href := routes.Home.home)("Return to Haichess homepage"), ".")
          )
        )
      }
}
