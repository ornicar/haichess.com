...
object index {
  ...
  def apply(
    ...
    val title = "Become a Patron of haichess.com"
              ...
              div(cls := "wrapper")(
                div(cls := "text")(
                  ...
                  p(
                    ...
                    "If you've gotten something out of Haichess, please take a second to pitch in!"
                  )
                ),
                div(cls := "content")(
...
<form class="paypal_checkout onetime none" action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
  ...
  <input type="hidden" name="item_name" value="haichess.com one-time">
  <input type="hidden" name="button_subtype" value="services">
  <input type="hidden" name="no_note" value="1">
  <input type="hidden" name="no_shipping" value="1">
  <input type="hidden" name="rm" value="1">
  <input type="hidden" name="return" value="https://haichess.com/patron/thanks">
  <input type="hidden" name="cancel_return" value="https://haichess.com/patron">
...
<form class="paypal_checkout monthly none" action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
  ...
  <input type="hidden" name="business" value="Q3H72BENTXL4G">
  <input type="hidden" name="item_name" value="haichess.com monthly">
  <input type="hidden" name="no_note" value="1">
  <input type="hidden" name="no_shipping" value="1">
  <input type="hidden" name="rm" value="1">
  <input type="hidden" name="return" value="https://haichess.com/patron/thanks">
...
<form class="paypal_checkout lifetime none" action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
  ...
  <input type="hidden" name="cmd" value="_xclick">
  <input type="hidden" name="business" value="Q3H72BENTXL4G">
  <input type="hidden" name="item_name" value="haichess.com lifetime">
  <input type="hidden" name="button_subtype" value="services">
  <input type="hidden" name="no_note" value="1">
  <input type="hidden" name="no_shipping" value="1">
  <input type="hidden" name="rm" value="1">
  ...
  <input type="hidden" name="currency_code" value="USD">
                      ...
                      st.group(cls := "radio buttons freq")(
                        div(
                          st.title := s"Pay ${lila.plan.Cents.lifetime.usd} once. Be a Haichess Patron forever!",
              ...
              div(cls := "best_patrons")(
                h2("The celebrated Patrons who make Haichess possible"),
                div(cls := "list")(
                  bestIds.map { userId =>
                    div(userIdLink(userId.some))
                  }
  ...
  private def faq(implicit ctx: Context) = div(cls := "faq")(
    dl(
      ...
      dd(
        ...
        "Then we pay a full-time developer: ", userIdLink("thibault".some), ", the founder of Haichess.", br,
        "See the ", a(href := "/costs", target := "_blank")("detailed cost breakdown.")
      ),
      dt("Is Haichess an official non-profit?"),
      dd(
        "Yes, here's the ", a(href := "http://www.journal-officiel.gouv.fr/association/index.php?ACTION=Rechercher&WHAT=haichess.com")(
          "act of creation (FR)"
        ), "."
      )
    ),
    dl(
      ...
      dd(
        ...
        "Or you can ", a(href := routes.Page.contact, target := "_blank")("contact Haichess support"), "."
      ),
    ...
    dl(
      ...
      dd(
        ...
        "Haichess is entirely free, forever, and for everyone. That's a promise. ",
