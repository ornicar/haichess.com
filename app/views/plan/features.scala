...
object features {
  ...
  def apply()(implicit ctx: Context) = views.html.base.layout(
    ...
    openGraph = lila.app.ui.OpenGraph(
      ...
      description = "All of Haichess features are free for all and forever. We do it for the chess!"
    ).some
  ) {
      main(cls := "box box-pad features")(
        table(
          ...
          tbody(
            ...
            tr(unlimited)(
              a(href := "https://haichess.com/blog/WN-gLzAAAKlI89Xn/thousands-of-stockfish-analysers")("Cloud engine analysis")
            ),
            tr(unlimited)(
              a(href := "https://haichess.com/blog/WFvLpiQAACMA8e9D/learn-from-your-mistakes")("Learn from your mistakes")
            ),
            tr(unlimited)(
              a(href := "https://haichess.com/blog/V0KrLSkAAMo3hsi4/study-chess-the-lichess-way")("Studies (shared and persistent analysis)")
            ),
            tr(unlimited)(
              a(href := "https://haichess.com/blog/VmZbaigAABACtXQC/chess-insights")("Chess insights (detailed analysis of your play)")
            ),
            tr(check)(
            ...
            tr(unlimited)(
              ...
              " through Haichess 1.5 billion games"
            ),
            tr(unlimited)(
          ...
          header(h1("Support Haichess")),
          tbody(cls := "support")(
            st.tr(
              th(
                "Contribute to Haichess and",
                br,
  ...
  private def header(name: Frag) = thead(
    st.tr(th(name), th("Free account"), th("Haichess Patron"))
  )
  ...
  private val title = "Haichess features"
