    ...
    views.html.base.layout(
      ...
      moreJs = jsTag("plan.js")
        ...
        main(cls := "box box-pad plan")(
          h1(
            userLink(me), " • ",
            if (patron.isLifetime) strong("Lifetime Haichess Patron")
            else frag("Haichess Patron for ", pluralize("month", me.plan.months))
          ),
          table(cls := "all")(
            tbody(
              tr(
                th("Current status"),
                td(
                  "You support haichess.com with ", strong(info.subscription.plan.usd.toString), " per month.",
              ...
              tr(
                ...
                td(cls := "change")(
                  ...
                  postForm(cls := "switch", action := routes.Plan.switch)(
                    p("Decide what Haichess is worth to you:"),
                    "USD $ ",
                  ...
                  postForm(cls := "cancel", action := routes.Plan.cancel)(
                    ...
                    submitButton(cls := "button button-red")("No longer support Haichess"),
              ...
              tr(
                th,
                td(a(href := routes.Plan.list)("View other Haichess Patrons"))
              )
            )
          )
        )
