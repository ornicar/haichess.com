  ...
  def apply(apps: List[lila.oauth.OAuthApp])(implicit ctx: Context) =
    views.html.account.layout(title = "OAuth Apps", active = "oauth.app")(
      div(cls := "account oauth box")(
        ...
        p(cls := "box__pad")(
          "Want to build something that integrates with and extends Haichess? Register a new OAuth App to get started developing on the Haichess API.",
          br, br,
          "Here's a ",
          a(href := "https://github.com/lichess-org/api/tree/master/example/oauth-authorization-code")("haichess OAuth app example"),
